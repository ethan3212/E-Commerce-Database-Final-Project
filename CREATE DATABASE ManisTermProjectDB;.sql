...
(
    ...
    /* Table Constraints */
    CONSTRAINT StateFeesPK PRIMARY KEY([State])
)
...
GO
 ...
 /* Drop Order, If Needed */
	/* 
	Drop view salesByCategory;
	Drop function GetExtendedPrice;
	Drop function SalesByMonth;
	Drop function TotalCost;
	Drop function GetCustomerActivityByID;
	...
	Drop database ManisTermProjectDB;
	*/
